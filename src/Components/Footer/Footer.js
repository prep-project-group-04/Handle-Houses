                ...
                <section id='infSection'>
                    ...
                    <nav id='listNave'>
                        ...
                        <ul>
                            ...
                            <li><Link id='listL' to='/resourse'>Resources</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav id="logo">
                        <p>Follow us on...</p>
                        <nav id="fip"><Link id='l1' to="https://web.facebook.com/profile.php?id=100091731711106"><img src="https://seeklogo.com/images/F/facebook-icon-logo-819DD0A07B-seeklogo.com.png" alt='facebook' /></Link></nav>
                        ...
                        <nav id="fip"><Link id='l1' to="https://twitter.com/handleHome_"><img src="https://www.freepnglogos.com/uploads/twitter-logo-png/twitter-logo-vector-png-clipart-1.png" alt='twitter' /></Link></nav>
